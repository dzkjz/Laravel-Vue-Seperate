    ...
    <div id="cafe-filter">
        <div class="grid-container" v-show="show">
            <div class="grid-x grid-padding-x">
                ...
                <div class="large-6 medium-6 small-12 cell">
                    <tags-input :unique="'cafe-search'"></tags-input>
                </div>
                ...
                <div class="brew-methods-container">
                    <div class="filter-brew-method" @click="toggleBrewMethodFilter(method.method)"
                         :class="{'active':brewMethods.indexOf(method.method)>-1}"
        ...
        <div class="grid-container">
            <div class="grid-x grid-padding-x">
                <span class="show-filters" @click="show=!show">
                    {{show?'隐藏过滤器↑':'显示过滤器↓'}}
                </span>
            </div>
        </div>
...
<script>
    // 引入标签输入组件
    import TagsInput from "../global/forms/TagsInput";
    ...
    export default {
        ...
        data() {
            return {
                textSearch: '',
                tags: [],
                isRoaster: false,//默认筛选出不是烘焙店的咖啡店
                brewMethods: [],
                show: true,
            }
        },
